...
export function MobileHeader() {
  ...
  return (
    <header className="md:hidden fixed top-0 left-0 w-full h-14 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md border-b border-neutral-200/50 dark:border-neutral-800/40 flex items-center justify-between px-6 z-[10000] transition-all shadow-none">
